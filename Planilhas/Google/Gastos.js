function DistribuirParcelas() {
    ...
    Logger.log('Primeira linha Historico = ' + PrimeiralinhaH);
     Logger.log('Ultima linha Historico =  ' + UltimalinhaH);
    ...
    var UltimaColunaParcela = Parcelas.getLastColumn();
     ...
     Logger.log('Formulario Primeira linha = ' + Primeiralinha);
     Logger.log('Formulario Ultima linha = ' + Ultimalinha);
     Logger.log('Ultima coluna Parcelas = ' + UltimaColunaParcela);
     Logger.log('Ultima linha Parcelas = ' + UltimaLinhaParcela);
